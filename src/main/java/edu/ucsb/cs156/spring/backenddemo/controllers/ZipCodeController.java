...
public class ZipCodeController {
    ...
    @Operation(summary = "Get Zipcode Info", description = "Zipcode Info from http://www.zippopotam.us/")
    @GetMapping("/get")
    public ResponseEntity<String> getzipcode(
        @Parameter(name="zipcode", description="zipcode, e.g. 93117") @RequestParam String zipcode
